...
/**
 * Adapted from Darkhax's <a href="https://github.com/Darkhax-Minecraft/Bookshelf">Bookshelf</a> A CodecHelper wraps a Codec to provide a large amount of helpers and utilities to make working with the
 * Codec easier and more flexible.
 *
...
public class MapCodecHelper<T> {
  ...
  /**
   * A function for creating an array of the codecs type. This allows us to create clean arrays for our codecs without relying on sketchy code.
   */
  ...
  /**
   * A helper for defining a field for an array of this type in a RecordCodecBuilder. For the sake of convenience single elements are treated as an array of one. If the field is not present the
  ...
  /**
   * A helper for defining a field for a list of this type in a RecordCodecBuilder. For the sake of convenience single elements are treated as a list of one. If the field is not present the fallback
   * will be used.
   *
   * @param fieldName The name of the field to read the value from.
   * @param getter    A getter that will read the value from an object of the RecordCodecBuilders type.
  ...
  /**
   * A helper for defining a field for a set of this type in a RecordCodecBuilder. For the sake of convenience single elements are treated as a set of one. If the field is not present the fallback
   * will be used.
   *
   * @param fieldName The name of the field to read the value from.
   * @param getter    A getter that will read the value from an object of the RecordCodecBuilders type.
   ...
   */
  public <O> RecordCodecBuilder<O, Optional<T>> getOptional(String fieldName,
      Function<O, Optional<T>> getter) {
   ...
   */
  public <O> RecordCodecBuilder<O, Optional<T>> getOptional(String fieldName,
      Function<O, Optional<T>> getter, Optional<T> fallback) {
