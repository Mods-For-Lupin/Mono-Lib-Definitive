...
/**
 * Holds the rules used to match a domain. Currently, rules can specify a domain and all subdomains,
 * or a subdomain and all nested subdomains.
 */
public class DomainRules {
  ...
  public boolean test(ZoneIdentifier identifier) {
    return identifier != null && (testDomain(identifier.getReferrer()) || testDomain(
        identifier.getHost()));
  }
